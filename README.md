# Spokane Cyber Cup Hackathon Participation
Overview
...
The Spokane Cyber Cup Hackathon is a Capture The Flag (CTF) event where teams work through security challenges and problem-solving tasks. These challenges are usually OSINT, system analysis, physical security, and vulnerability identification.

During the event, I participated in many cybersecurity challenges. A few that stand out are Audio bit to binary analysis, Press Your Luck, and location OSINT identification.

Proof of Participation

See the image located in:
proof-of-participation
